...
namespace Ragnarok.Modules.RagnarokCheckIn
{
    ...
    /// 
    /// Because the control inherits from RagnarokCheckInSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : RagnarokCheckInModuleSettingsBase
    {
